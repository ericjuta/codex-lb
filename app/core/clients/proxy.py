...
async def _stream_responses_with_session(
    ...
    if _codex_continuation_enabled and should_apply_codex_continuation(payload_dict, codex_continuation_config):
        ...
        async def _open_continuation_round(round_payload: JsonObject) -> AsyncGenerator[str, None]:
            ...
            async with contextlib.aclosing(
                ...
                async for event_block in round_events:
                    yield event_block
        ...
        async with contextlib.aclosing(
            ...
            async for event_block in folded_events:
                yield event_block
        return
