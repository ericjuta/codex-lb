...
- [x] 4.3 Bind real PostgreSQL engine creation to declared roles and pin the Helm-owned `app.cli` command to one worker.
- [x] 4.4 Add focused runtime, Helm worker-command, pool-budget, template-plumbing, and documentation regression tests.
