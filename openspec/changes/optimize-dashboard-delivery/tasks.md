...
- [x] 2.2 Add and pass focused integration coverage for dashboard compression, cache headers, ranged assets, and proxy-route exclusion.
...
- [x] 3.2 Verify the production entry graph excludes unvisited route modules and static/modulepreloaded Recharts code.

## 4. Self-hosted font

- [x] 4.1 Port the JetBrains Mono assets and local font declarations from `acfb295e` and remove Google Fonts references.
- [x] 4.2 Verify the production build contains the local font files and no Google Fonts origin references.
