...
- [x] 9. Adapt the fork's internal bridge route to read `previous_response_id` from the validated typed payload so the route-level settlement regression reaches the compact path.
