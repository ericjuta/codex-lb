# direct-websocket-liveness Specification

## Purpose

Define bounded connection establishment and visible failure behavior for direct
upstream Responses WebSockets so that a slow account cannot leave a downstream
session pending indefinitely.
